...
export default function Sponsors() {
  ...
  return (
    ...
    <div className="container-fluid px-0">
      <div className="row position-relative px-0 mx-0 bg-dark" style={{filter:"blur(5px)" , marginTop:"-10%"}} ><img src="images/sponsor.jpg" className='px-0 mx-0 opacity-50' alt="" /></div>
