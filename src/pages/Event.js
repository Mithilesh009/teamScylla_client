...
export default function Event() {
  ...
  return (
    ...
    <div className="container-fluid bg-dark">
        <div className="row img-row  "><img src="images/event.jpg" className='px-0 mx-0' alt="" /></div>
        <div className="row ab-row-2 justify-content-center w-100 ">
            ...
            <div className="row justify-content-center">
                <div className="col col-xl-5 col-lg-5 col-md-5 col-sm-12 order-xl-1 order-lg-1 order-md-1 order-sm-2"><img src="images/Picture6.jpg" className='img-fluid' alt="" /></div>
...
{/* <div className="container-fluid bg-dark p-5">
    <div className="row p-5">
      <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center text-light">
        <img src="images/logoScylla-W.png" width="70px" alt="" />
        <h2 >TEAM SCYLLA RACING</h2>
        <h6>" PERFORMANCE OVER EVERYTHING "</h6>
        <hr style={{color:"white" , fontWeight:"bolder"}}/>
      </div>
      <div className="col col-xl-8 col-lg-6 col-md-6 col-sm-12 text-center text-light offset-xl-2 offset-sm-0 ">
    
        <h1 className='pb-5'>OUR JOURNEY</h1>
        <p>The journey of Team Scylla began way back in 2017 when a group of 25 undergraduates dared to do something different. They came up with an idea of forming a team which will build an All-Terrain Vehicle (ATV) to compete in the prestigious competition of Quad Torc.</p>
      </div>
    </div>

    <div className="row text-light text-center p-xl-5 p-lg-5 p-md-3 p-sm-2 bg-dark " >
                    <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-3">
                        ...
                        <div className="row m-1">
                            ...
                            <div className="col col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div className="card mx-auto p-3 bg-dark">
                                    <div className="card-body  " >
                                        <div className="card-title"><h2>SHADOW 3.0 (2021-22)</h2></div>
