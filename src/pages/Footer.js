                    ...
                    <div className="row text-light">
                        <div className="col foot-col col-xl-4 col-lg-4 col-md-4 col-sm-12">
                            <div className="row ">
                                ...
                                <div className="col ts-col2 col-xl-8 col-lg-8 col-md-8 col-sm-8 mt-4 mt-xl-4 mt-lg-2 mt-md-2"><span style={{fontSize:"200%" , fontWeight:"600"}}> TEAM SCYLLA </span> <br /><p style={{fontSize:"2.5vh"}}> "Performance Over Everything"</p></div>
                            </div>
                        </div>
                        ...
                        <div className="row">
                                <div className="col col-xl-12 col-lg-12 col-md-12 col-sm-6" >
                                    ...
                                    <div className="row">
                                        <div className="col col-1 "><a href="/" className='text-light'><i className="fa-solid fa-map-location-dot"></i></a></div>
                                        <div className="col"><p> Mechanical Workshop , Nutan Maharastra Institute of Engineering And Technology , Talegaon Dhabade , Pune </p></div>
                                    </div>
                                </div>
